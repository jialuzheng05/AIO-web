...
const projects = ['Solvely.AI 首页', 'AI Study Home', 'Humanizer Workspace', 'AI Research'] as const
type ProjectName = (typeof projects)[number]
const selectedProject = ref<ProjectName>('AI Research')
    ...
    >
      <section class="citation-dialog" role="dialog" aria-modal="true" aria-labelledby="citation-dialog-title">
        ...
        <footer class="citation-dialog-footer">
          <button class="citation-cancel" type="button" @click="closeCitationDialog">Cancel</button>
